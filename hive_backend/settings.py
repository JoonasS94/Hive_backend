...
SECRET_KEY = 'django-insecure-0gr2lof_u6kpvz9b71^_ktvls_fj075l76t5^4u)(r7c%tq8yv'
...
AUTH_USER_MODEL = 'hive_backend.CustomUser'
...
SWAGGER_SETTINGS = {
    'DEFAULT_INFO': 'myapi.urls.schema_view',
